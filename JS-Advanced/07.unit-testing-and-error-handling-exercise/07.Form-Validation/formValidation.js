function validate() {
    ...
    function validateFormHandler(e){
        ...
        let passwordIsMatching = passwordIsValid  && passwordInput.value === confirmPasswordInput.value;
        setBorder(passwordInput, passwordIsMatching);
        setBorder(confirmPasswordInput, passwordIsMatching);
        ...
        let mainInputsAreValid = usernameIsValid && emailIsValid && passwordIsMatching
