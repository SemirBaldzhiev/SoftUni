...
namespace CarDealer
{
    public class StartUp
    {
        ...
        public static string GetCarsWithDistance(CarDealerContext context)
        {
            ...
            var serializer = new XmlSerializer(typeof(ExportCarDistanceDto[]), new XmlRootAttribute("cars"));
        ...
        public static string GetCarsFromMakeBmw(CarDealerContext context)
        {
            ...
            var serializer = new XmlSerializer(typeof(ExportCarMakeDto[]), new XmlRootAttribute("cars"));
            serializer.Serialize(writer, cars, ns);
        ...
        public static string GetSalesWithAppliedDiscount(CarDealerContext context)
        {
            ...
            var serializer = new XmlSerializer(typeof(ExportSaleDiscountDto[]), new XmlRootAttribute("sales"));
